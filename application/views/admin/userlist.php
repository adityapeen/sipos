        ...
        <div class="col-xl-12 col-lg-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    ...
                    <a href="<?= base_url('admin/adduser'); ?>" class="btn btn-primary btn-sm text-white-70 small"><b>Tambah User</b></a>
                </div>
                <!-- Card Body -->
                <div class="card-body">
                                    ...
                                    <table class="table table-bordered dataTable" id="userTable" cellspacing="0" role="grid" aria-describedby="dataTable_info">
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1">Puskesmas</th>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <form method="post" id="formReset" action="<?= base_url('auth/resetPassword'); ?>">
                        <input type="hidden" id="tipereset" name="tipe" value="admin">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <form method="post" id="formDelete" action="<?= base_url('auth/deleteuser'); ?>">
                        <input type="hidden" id="tipedelete" name="tipe" value="admin">
        ...
        $.getJSON("<?= base_url('api/getdatauser'); ?>", {
            ...
            .done(function(data) {
                $.each(data, function(idx, e) {
                    ...
                    $('#role').prop('selectedIndex', e.role_id);
